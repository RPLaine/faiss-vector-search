"""
Embedding Service for System 2 (AI Journalist)

Handles sentence transformer model initialization and embedding generation.
Duplicated from components/core/embedding_service.py for system isolation.
"""
...
class EmbeddingService:
    ...
    def __init__(self, model_name: str, expected_dimension: int):
        ...
        Raises:
            EmbeddingError: If model loading fails or dimension mismatch
        """
        ...
        try:
            ...
            if actual_dim != self.expected_dimension:
                error_msg = (
                    ...
                    f"Update settings.json retrieval.dimension to {actual_dim}"
                )
