"""
Index Service for System 2 (AI Journalist)

Manages FAISS index operations: creation, loading, saving, and document addition.
Duplicated from components/core/index_service.py for system isolation.
"""
...
class IndexService:
    ...
    def load_or_create(self) -> None:
        ...
        if os.path.exists(self.index_path) and os.path.exists(self.metadata_path):
            ...
            logger.info("Creating new FAISS index for System 2")
            self.create_new()
    ...
    def load(self) -> None:
        ...
        if not os.path.exists(self.index_path):
            logger.warning(f"Index file not found: {self.index_path}, creating new")
            self.create_new()
            return
        
        if not os.path.exists(self.metadata_path):
            logger.warning(f"Metadata file not found: {self.metadata_path}, creating new")
            self.create_new()
            return
    ...
    def is_initialized(self) -> bool:
        """Check if index is initialized (can be empty)."""
